      ...
      <section className="aboutGrid">
        <div>
          ...
          <p className="paragraph">
            ...
            started only eating meat a few times a week. After a few months, she
            decided to eliminate it completely and made the switch to fully
            plant based eating. Her philosophy is not about being a perfect
            vegan, but about making as many plant-based choices as possible to
            eliminate her impact on the world. She is an avid outdoor enthusiast
            who runs ultramarathons, mountain bikes, hikes, snowboards, and gets
            outside as much as possible. Usually you will find her on the trails
            with her two pups Lana, a treeing walker coonhound mix, and Nova, a
            siberian husky, or drinking a beer at Fossil Craft Beer Co. Her
            favorite restaurant in the area is Bambino’s because she can load as
            many toppings on the pizza as it can fit and top it with pistachios!
          </p>
        </div>
        <div>
          <div className="aboutPhoto">
          ...
          <p className="paragraph">
            ...
            cheese). Years later, and a degree in animal behavior later, it
