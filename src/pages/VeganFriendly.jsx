...
export default function VeganFriendly() {
  return (
    <div className="VeganFriendly">
      ...
      <Restaurant
        restaurantName="Adam's Mountain Cafe"
      ...
      />
      <Restaurant
        restaurantName="Javalato Gelato & Cafe"
      ...
      />
      <Restaurant
        restaurantName="Mountain Mama Natural Foods"
      ...
      />
      <Restaurant
        restaurantName="Salad or Bust Downtown"
        street="8 E Bijou St"
        cityZip="Colorado Springs, CO 80903"
      ...
      />
      <Restaurant
        restaurantName="Sherpa Garden Restaurant & Bar"
